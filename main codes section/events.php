...
<head>
    ...
    <title>Events - Social Services Hub</title>
    ...
    <style>
        ...
        .event-card:hover {
            ...
            box-shadow: 0 10px 25px rgba(0, 0, 0, 0.5), 0 0 15px rgba(0, 255, 149, 0.4);
        }
        .event-card h5 {
            color: #00ff95;
            font-family: 'Orbitron', sans-serif;
                ...
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <div class="col-md-4 mb-4">
                        <div class="event-card">
                            ...
                            <p><strong>Date:</strong> <span class="event-date"><?php echo date('d M Y', strtotime($row['event_date'])); ?></span></p>
